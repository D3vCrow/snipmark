...
export namespace main {
	...
	export class ExpandResult {
	    ...
	    static createFrom(source: any = {}) {
	        return new ExpandResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.appliedLeft = source["appliedLeft"];
	        this.appliedTop = source["appliedTop"];
	        this.appliedRight = source["appliedRight"];
	        this.appliedBottom = source["appliedBottom"];
